...
// ----------------------------------------------------
// REQUIRED INTERFACES FOR SERVER.TS TO PASS HEADERS
// ----------------------------------------------------
...
// ----------------------------------------------------
// REMOVED GLOBAL INITIALIZATION (Now done per-request)
// ----------------------------------------------------
...
    model: getModel({ apiKey: apiKeys.openai }), // FIX: Use key from headers
    system: systemPrompt(),
